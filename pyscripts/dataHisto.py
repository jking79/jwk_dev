...
plt.savefig( "MeanFrequencyPlot.png", format = "png")
##plt.show()
...
plt.savefig( "MeanPeriodPlot.png", format = "png")
##
...
plt.savefig( "DiffrencePlot.png", format = "png")
##
print('Stdev v period')
plt.figure(4)
plt.plot( xlist, listsqrt(vrlist), '-b', label = "Rise" )
plt.plot( xlist, listsqrt(vflist), '-r', label = "Fall" )
plt.plot( xlist, listsqrt(vslist), '-g', label = "Rise + Fall" )
plt.plot( xlist, listsqrt(vdlist), '-k', label = "Rise - Fall" )
plt.legend(loc='upper right')
plt.ylabel("Standard Deviation: 1.6 microseconds" )
plt.xlabel("Period of SigGenerator")
plt.title("Standard Deiations vs SigGen Period")
plt.savefig( "StdDevPlot.png", format = "png")
